// Paste to frontend/node_modules/@azesmway/react-native-unity/android/src/main/java/com/azesmwayreactnativeunity/UPlayer.java
...
public class UPlayer {
    ...
    public FrameLayout requestFrame() throws NoSuchMethodException {
        try {
            ...
            // Fallback: try to get a View from unityPlayer using reflection
            FrameLayout layout = new FrameLayout(unityPlayer.getContext());
            System.out.println("unityPlayer class: " + unityPlayer.getClass().getName());
            try {
                Method getView = unityPlayer.getClass().getMethod("getView");
                android.view.View unityView = (android.view.View) getView.invoke(unityPlayer);
                layout.addView(unityView);
            } catch (Exception inner) {
                throw new RuntimeException("Cannot get a View from unityPlayer. Class: " + unityPlayer.getClass().getName(), inner);
            }
            return layout;
        }
    }
